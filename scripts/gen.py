...
HTML_FILE = "../flower-makeup-template/flower-makeup-template.html"
FULL_IMG = "../flower-makeup-template/email_full.png"
THUMB_IMG = "../flower-makeup-template/email_thumb.png"

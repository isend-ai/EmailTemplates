...
HTML_FILE = "../delivery_details_template/delivery_details_template.html"
FULL_IMG = "../delivery_details_template/email_full.png"
THUMB_IMG = "../delivery_details_template/email_thumb.png"

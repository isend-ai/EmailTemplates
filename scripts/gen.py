...
HTML_FILE = "../one-day-sale-template/one-day-sale-template.html"
FULL_IMG = "../one-day-sale-template/email_full.png"
THUMB_IMG = "../one-day-sale-template/email_thumb.png"

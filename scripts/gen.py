...
HTML_FILE = "../black-friday-sale-template/black-friday-sale.html"
FULL_IMG = "../black-friday-sale-template/email_full.png"
THUMB_IMG = "../black-friday-sale-template/email_thumb.png"

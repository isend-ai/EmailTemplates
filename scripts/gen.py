...
HTML_FILE = "../holiday-booking-temp/holiday-booking-templates.html"
FULL_IMG = "../holiday-booking-template/email_full.png"
THUMB_IMG = "../holiday-booking-template/email_thumb.png"

...
HTML_FILE = "../airline_ticket_template/airline_ticket_template.html"
FULL_IMG = "../airline_ticket_template/email_full.png"
THUMB_IMG = "../airline_ticket_template/email_thumb.png"
